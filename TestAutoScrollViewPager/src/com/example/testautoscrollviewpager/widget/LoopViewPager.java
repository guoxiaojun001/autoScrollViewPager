package com.example.testautoscrollviewpager.widget;
...
public class LoopViewPager extends ViewPager {
    ...
    /** 更新标题监听 */
    public OnUpdateTitleListener updateTitleListener = null;
	...
	/** 设置更新标题监听 */
	public void setOnUpdateTitleListener(OnUpdateTitleListener listener) {
		updateTitleListener = listener;
	}
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        updateTitleListener.updateTitle(0);
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
                ...
                int realPosition = mAdapter.toRealPosition(position);
                updateTitleListener.updateTitle(realPosition);
